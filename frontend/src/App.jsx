...
import PricePredictor from './Pages/PricePredictor.jsx';
import InvestmentAnalyzer from './Pages/InvestmentAnalyzer.jsx';
import LifestyleMatch from './Pages/LifestyleMatch.jsx'; // Import the new component
      ...
      <BrowserRouter>
        ...
        <Routes>
          ...
          <Route element={<PrivateRoute />}>
            ...
            <Route path="/create-listing" element={<CreateListing />} />
            <Route path="/update-listing/:listingId" element={<UpdateListing />} />
            {/* Lifestyle Match - Protected Route */}
            <Route path="/lifestyle-match" element={<LifestyleMatch />} />
          </Route>
