  ...
  useEffect(() => {
    ...
    const fetchRentListings = async () => {
      try {
        ...
        console.log(text); // Inspect what the server is returning
  ...
  return (
    <div>
      ...
      <div className='flex flex-col gap-6 p-28 px-3 max-w-6xl mx-auto'>
        ...
        <Link
          to={'/search'}
          className='text-xs sm:text-lg text-blue-800 font-bold '
        >
          Let's get started...
        </Link>
      </div>
        ...
        {saleListings && saleListings.length > 0 && (
          <div className=''>
            <div className='my-3'>
              ...
              <Link className='text-sm text-blue-800 ' to={'/search?type=sale'}>Show more places for sale</Link>
            </div>
            <div className='flex flex-wrap gap-4'>
